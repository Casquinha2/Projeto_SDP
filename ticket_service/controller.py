...
def create_ticket():
    ...
    ticket = Ticket(ticket_id=ticket_data['ticket_id'],event_id=ticket_data['event_id'],total_tickets=ticket_data['total_tickets'], available_tickets=ticket_data['available_tickets'], price = ticket_data['price'])
